...
class AramusModel(object):
    def generate(self, question, state):
        ...
        print("autoqa_all new question:", new_question)
        ...
        # send url
        url = 'http://192.168.0.48:3942/momrah_gpt/visual_pollution_qa'

        #url = 'http://37.224.68.132:23942/momrah_gpt/visual_pollution_qa'
        headers = {
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if source_lang == "ar":
                    answer = output['answer_ar']
                else:
                    answer = output['answer_en']

                print("autoqa_all http answer:", answer)
                return answer
...
# # #
# # # # send question demo
# question = "\nYou: May a Light pole cause visual pollution?"
