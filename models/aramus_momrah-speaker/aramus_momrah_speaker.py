...
class AramusModel(object):
    def generate(self, question, state):
        ...
        print("path:", new_question)
        # send url
        url = 'http://192.168.0.175:3006/speaker_test'
        #url = "http://37.224.68.132:26006/speaker_test"

        try:
            files = {'audio': ("2428-83699-0003.flac",open(new_question, 'rb'))}
            ...
            if response.status_code == 200:
                ...
                print("speaker response:", output)
                result = "prediction: "+str(prediction)
                if(prediction):
                    speaker = output['most similary speaker']
                    result += ", most similary speaker:"+speaker
                    print("result:", result)
                return result
...
# # #
# # # # # send question demo
# question = "\nYou: /var/folders/gd/nnzymklj61l7gxpjx0lgdvkr0000gn/T/gradio/78e8d3385b3bff931eba7f45552fc612a92bdeed/Google_Checkout-0-100.mp3\nAramus:"
